  ...
  return (
    <>
      <div className="font-light sm:hidden w-screen flex justify-center items-center text-xl text-center mt-9 mb-5">
        <h1>
          👋 , My name is pradeep i am 
        </h1>
      </div>


      <div className="font-azonix text-[#1b1b1b] leading-[3rem] sm:leading-[8.5rem] flex flex-col items-center justify-center relative sm:py-[2%] select-none">
        <h1
          ref={textRef1}
...
<h1 className="  text-[#1b1b1b] font-medium opacity-65 select-none z-10 absolute top-64 sm:top-[63%] left-6 sm:left-32">based in <br />Chh. Sambhajinagar, Maharashtra</h1>
